	...
	for dire in d:
		...
		for line in place_file.readlines():
			...
			if line.startswith("ENDMDL"):
				...
				#break loop since we are only looking at the best energy model (listed first)
				break
		...
		write_rmsd = open(r + "/" + dire + "/best_ddg_rmsd.txt", "w")
...
final_out = open("final_rmsd_best_ddg.txt", "w")
